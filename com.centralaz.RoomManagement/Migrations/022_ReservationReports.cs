...
namespace com.centralaz.RoomManagement.Migrations
{
    ...
    public class ReservationReports : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateFieldType( "Report Template", "", "com.centralaz.RoomManagement", "com.centralaz.RoomManagement.Field.Types.ReportTemplateFieldType", "6B88A513-4B4C-403B-ADFA-82C3A2B1C3B8");
            ...
            if ( lavaTemplate.Trim() != "{% include '~/Plugins/com_centralaz/RoomManagement/Assets/Lava/Reservation.lava' %}" )
            {
